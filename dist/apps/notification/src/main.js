...
let NotificationController = class NotificationController {
    ...
    handleDeleted(dto) {
        return this.notificationService.deleteNotificationItem(dto.user_id, dto.id);
    }
};
exports.NotificationController = NotificationController;
__decorate([
    (0, microservices_1.EventPattern)('notifications'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_b = typeof common_2.userId !== "undefined" && common_2.userId) === "function" ? _b : Object]),
    __metadata("design:returntype", typeof (_c = typeof Promise !== "undefined" && Promise) === "function" ? _c : Object)
], NotificationController.prototype, "handleNotifications", null);
__decorate([
    (0, microservices_1.EventPattern)('update_isRead'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_d = typeof common_2.userId !== "undefined" && common_2.userId) === "function" ? _d : Object]),
    __metadata("design:returntype", typeof (_e = typeof Promise !== "undefined" && Promise) === "function" ? _e : Object)
], NotificationController.prototype, "handleUpdateIsRead", null);
__decorate([
    (0, microservices_1.EventPattern)('create_msg_notify'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_f = typeof common_2.NotificationMsg !== "undefined" && common_2.NotificationMsg) === "function" ? _f : Object]),
    __metadata("design:returntype", typeof (_g = typeof Promise !== "undefined" && Promise) === "function" ? _g : Object)
], NotificationController.prototype, "handleCreateMsg", null);
__decorate([
    (0, microservices_1.EventPattern)('delete_notification'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", typeof (_h = typeof Promise !== "undefined" && Promise) === "function" ? _h : Object)
], NotificationController.prototype, "handleDeleted", null);
...
const notification_repository_1 = __webpack_require__(/*! ./notification.repository */ "./apps/notification/src/notification.repository.ts");
const mongoose_1 = __webpack_require__(/*! @nestjs/mongoose */ "@nestjs/mongoose");
const notification_schemas_1 = __webpack_require__(/*! ./schemas/notification.schemas */ "./apps/notification/src/schemas/notification.schemas.ts");
            ...
            mailer_1.MailerModule.forRootAsync({
                useFactory: async (configService) => ({
                    transport: {
                        ...
                        service: 'gmail',
                        auth: {
                            user: configService.get('USERNAME_EMAIL'),
...
/***/ "./apps/notification/src/notification.repository.ts":
/*!**********************************************************!*\
  !*** ./apps/notification/src/notification.repository.ts ***!
  \**********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const common_2 = __webpack_require__(/*! @app/common */ "./libs/common/src/index.ts");
const notification_schemas_1 = __webpack_require__(/*! ./schemas/notification.schemas */ "./apps/notification/src/schemas/notification.schemas.ts");
let NotificationRepository = NotificationRepository_1 = class NotificationRepository extends common_2.AbstractRepository {
    constructor(notificationModel, connection) {
...
exports.NotificationRepository = NotificationRepository = NotificationRepository_1 = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(notification_schemas_1.Notification.name)),
...
let NotificationService = class NotificationService {
    constructor(mailerService, notificationRepository) {
    ...
    async updateNotificationsAsRead(userId) {
        try {
            const result = await this.notificationRepository.updateMany({ userId: userId, 'notifications.isReaded': false }, {
                $set: {
                    'notifications.$[elem].isReaded': true,
                    'notifications.$[elem].readedAt': new Date(),
                },
            }, {
                arrayFilters: [{ 'elem.isReaded': false }],
                multi: true,
            });
            if (!result.length) {
                return {
    ...
    async createNotification({ user_id, msg, }) {
        try {
            const result = {
            ...
            await this.notificationRepository.upsert({ userId: user_id }, {
                $set: { userId: user_id },
                $push: {
    ...
    async deleteNotificationItem(userId, notificationItemId) {
        const result = await this.notificationRepository.updateMany({ userId: userId }, {
            $pull: {
                notifications: {
                    _id: new mongoose_1.Types.ObjectId(notificationItemId),
                },
            },
        });
        if (!result.length) {
...
exports.NotificationService = NotificationService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeof (_a = typeof mailer_1.MailerService !== "undefined" && mailer_1.MailerService) === "function" ? _a : Object, typeof (_b = typeof notification_repository_1.NotificationRepository !== "undefined" && notification_repository_1.NotificationRepository) === "function" ? _b : Object])
], NotificationService);


/***/ }),

/***/ "./apps/notification/src/schemas/notification.schemas.ts":
/*!***************************************************************!*\
  !*** ./apps/notification/src/schemas/notification.schemas.ts ***!
  \***************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
], NotificationItem.prototype, "_id", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: String, required: true }),
    __metadata("design:type", String)
], NotificationItem.prototype, "msg", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: Boolean, default: false }),
    __metadata("design:type", Boolean)
], NotificationItem.prototype, "isReaded", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: Date, default: () => new Date() }),
    __metadata("design:type", typeof (_b = typeof Date !== "undefined" && Date) === "function" ? _b : Object)
], NotificationItem.prototype, "createdAt", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: Date, default: null }),
    __metadata("design:type", typeof (_c = typeof Date !== "undefined" && Date) === "function" ? _c : Object)
], NotificationItem.prototype, "readedAt", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: Date, default: null }),
    __metadata("design:type", typeof (_d = typeof Date !== "undefined" && Date) === "function" ? _d : Object)
], NotificationItem.prototype, "deletedAt", void 0);
NotificationItem = __decorate([
    (0, mongoose_1.Schema)()
], NotificationItem);
const NotificationItemSchema = mongoose_1.SchemaFactory.createForClass(NotificationItem);
let Notification = class Notification extends common_1.AbstractDocument {
};
...
__decorate([
    (0, mongoose_1.Prop)({ type: [NotificationItemSchema], default: [] }),
...
async function bootstrap() {
    const configApp = await core_1.NestFactory.create(notification_module_1.NotificationModule);
