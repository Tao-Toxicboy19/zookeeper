...
/***/ "./apps/mail-queue/src/consumer.module.ts":
/*!************************************************!*\
  !*** ./apps/mail-queue/src/consumer.module.ts ***!
  \************************************************/
...
const consumer_service_1 = __webpack_require__(/*! ./consumer.service */ "./apps/mail-queue/src/consumer.service.ts");
...
/***/ "./apps/mail-queue/src/consumer.service.ts":
/*!*************************************************!*\
  !*** ./apps/mail-queue/src/consumer.service.ts ***!
  \*************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
let ConsumerService = ConsumerService_1 = class ConsumerService {
    constructor(configService, mailerService, redisService) {
    ...
    async onModuleInit() {
        this.channelWrapper.addSetup((channel) => {
            channel.consume(this.otpMailQueue, async (msg) => {
                if (msg) {
                    const content = JSON.parse(msg.content.toString());
                    await this.handleSendOtp({
                        email: content.email,
                        message: JSON.stringify({
                            id: new mongodb_1.ObjectId(content._id).toHexString(),
        ...
        this.channelWrapper.addSetup((channel) => {
            channel.consume(this.resetPassswordQueue, async (msg) => {
                if (msg) {
    ...
    async handleSendResetPassword(email, token) {
    ...
    async handleSendOtp(dto) {
        const user = JSON.parse(dto.message);
        try {
...
exports.ConsumerService = ConsumerService = ConsumerService_1 = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof config_1.ConfigService !== "undefined" && config_1.ConfigService) === "function" ? _a : Object, typeof (_b = typeof mailer_1.MailerService !== "undefined" && mailer_1.MailerService) === "function" ? _b : Object, typeof (_c = typeof common_2.RedisService !== "undefined" && common_2.RedisService) === "function" ? _c : Object])
], ConsumerService);
...
const microservices_1 = __webpack_require__(/*! @nestjs/microservices */ "@nestjs/microservices");
const config_1 = __webpack_require__(/*! @nestjs/config */ "@nestjs/config");
const consumer_module_1 = __webpack_require__(/*! ./consumer.module */ "./apps/mail-queue/src/consumer.module.ts");
