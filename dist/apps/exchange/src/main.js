...
const kafka_producer_module_1 = __webpack_require__(/*! ./producer/kafka-producer.module */ "./apps/exchange/src/producer/kafka-producer.module.ts");
...
exports.ExchangeModule = ExchangeModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            kafka_producer_module_1.KafkaProducerModule,
        ],
...
const kafka_producer_service_1 = __webpack_require__(/*! ./producer/kafka-producer.service */ "./apps/exchange/src/producer/kafka-producer.service.ts");
...
let ExchangeService = ExchangeService_1 = class ExchangeService {
    constructor(keyClient, kafkaProducerService) {
    ...
    async encypt(value, secret) {
        return (0, jsonwebtoken_1.verify)(value, secret);
    }
...
exports.ExchangeService = ExchangeService = ExchangeService_1 = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof microservices_1.ClientGrpc !== "undefined" && microservices_1.ClientGrpc) === "function" ? _a : Object, typeof (_b = typeof kafka_producer_service_1.KafkaProducerService !== "undefined" && kafka_producer_service_1.KafkaProducerService) === "function" ? _b : Object])
], ExchangeService);


/***/ }),

/***/ "./apps/exchange/src/producer/kafka-producer.module.ts":
/*!*************************************************************!*\
  !*** ./apps/exchange/src/producer/kafka-producer.module.ts ***!
  \*************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const kafka_producer_service_1 = __webpack_require__(/*! ./kafka-producer.service */ "./apps/exchange/src/producer/kafka-producer.service.ts");
let KafkaProducerModule = class KafkaProducerModule {
};
exports.KafkaProducerModule = KafkaProducerModule;
exports.KafkaProducerModule = KafkaProducerModule = __decorate([
    (0, common_1.Module)({
...
/***/ "./apps/exchange/src/producer/kafka-producer.service.ts":
/*!**************************************************************!*\
  !*** ./apps/exchange/src/producer/kafka-producer.service.ts ***!
  \**************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
